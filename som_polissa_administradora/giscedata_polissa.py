...
ERROR_CODES = {
    '00': {
        'msg': u'[00] La pòlissa no té cap modificació contractual',
        'skip_error': False
    },
    '01': {
        'msg': u"[01] No s'ha especificat un partner existent",
        'skip_error': True
    },
    '02': {
        'msg': u"[02] S'han d'especificar els permisos",
        'skip_error': True
    },
    '03': {
        'msg': u"[03] Partner '%s' ja administra aquesta pòlissa.",
        'skip_error': True
    },
    '04': {
...
class GiscedataPolissa(osv.osv):
    ...
    _columns = {
        ...
        'administradora_nif': fields.related(
            'administradora', 'vat', type='char',
            string='NIF administradora', readonly=True),
