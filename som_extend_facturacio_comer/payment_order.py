...
class payment_order(osv.osv):
    ...
    def add_invoices_to_payment_order(self, cursor, uid, mode_pagament_id, data_venciment, context=None):
        """
    ...
    def _cronjob_remesa_automatica(self, cursor, uid, context=None):
        ...
        mode_pagament_id = irmd_o.get_object_reference(
            cursor, uid, 'som_extend_facturacio_comer',
            'payment_mode_remesa_automatica'
        )[1]
