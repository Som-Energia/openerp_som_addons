            ...
            <div class="a4">
                <div class="page-content">
                    <div class="content">
                        ...
                        <p>
                        ${informe['name']},  ${_(u"major d'edat, amb domicili a")} ${informe['address']} ${_(u"i DNI número")} ${informe['nif']}, ${_(u"de forma lliure i voluntària i en ple ús de les meves facultats, i en tant que titular del CUPS")} ${informe['cups']} ${_(u"associat a l'autoconsum col·lectiu CAU")} ______________ ${_(u"(“Autoritzant”)")}
                        </p>
                        <p>
                        ${informe["rep_name"'']}, ${_(u"major d'edat, amb NIF número")} ${informe['nif']} ${_(u"i domicili a")} ${informe['address']}, ${_(u"actuant en la meva condició de")}________________, ${_(u"i manifestant que en aquesta condició disposo de les facultats suficients, actuant EN NOM I REPRESENTACIÓ DE")} ${informe["name"]} , ${_(u"amb NIF")} ____ ${_(u"i domicili social a")} _____ ${_(u"com a titular del CUPS")} ${informe['cups']}${_(u"(“Autoritzant”)")}
                        </p>
                        <p>
                            <b> ${_(u"AUTORITZO:")} </b>
                        </p>
                        <p>
                        ${_(u"SOM ENERGIA, SCCL, amb NIF F55091367 i domicili social al carrer  Pic de Peguera 11, planta, 17003 Girona (“Autoritzada”) a actuar com a representant  integral del meu CUPS en tant que associat a l'autoconsum col·lectiu CAU provisional")} ______________, ${_(u"per termini il·limitat, a fi que pugui dur a terme les ACTUACIONS següents:")}
                        </p>
                        <ul>
                            <li>
