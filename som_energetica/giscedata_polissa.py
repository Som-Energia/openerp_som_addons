...
class GiscedataPolissa(osv.osv):
    ...
    def get_bad_energetica_partners(self, cursor, uid, contract_ids, context=None):
        ...
        for contract_id in contract_ids:
            ...
            if (
                ...
                not in [x.id for x in contract.bank.partner_id.category_id]
            ):
            ...
            if (
                ...
                and cat_energetica_id
                not in [
                    x.id for x in contract.direccio_notificacio.partner_id.category_id
                ]
            ):
    ...
    def set_energetica(self, cursor, uid, contract_ids, context=None):
        ...
        for bad_id in bad_partners_ids:
            ...
            partner_obj.write(
                cursor, uid, bad_id, {"category_id": [(6, 0, [cat_energetica_id])]}
            )
