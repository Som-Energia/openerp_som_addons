...
class TestWizardTugestoInvoicesExport(testing.OOTestCase):
    ...
    def test__tugesto_invoices_export__wontWork(self):
        with Transaction().start(self.database) as txn:
            ...
            self.pool.get('res.partner.address').write(cursor, uid, adreces, 
