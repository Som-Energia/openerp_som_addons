...
class WizardAccountBalanceReport(osv.osv_memory):
    ...
    def check_all_accounts(self, cr, uid, ids, datas, context=None):
        ...
        if datas["form"]["all_accounts"]:
            ...
            raise osv.except_osv(
                _("Error"), _("Account list or 'all accounts' check required")
            )
    ...
    def report_csv_send_async(self, cr, uid, ids, datas, context=None):
        ...
        # TODO: Save file to MongoDB to support workers in
        # different server of main instance
    ...
    _columns = {
        ...
        "wiz_state": fields.selection(
            [("done", "Done"), ("send", "Send")], "wizard state"
        ),
    }
