...
class WizardPaymentOrderAddInvoices(osv.osv_memory):
    ...
    def add_invoices_to_payment_order(self, cursor, uid, ids, context=None):
        ...
        search_params_relation = {
            ...
            "pending_state_text": [
                ("pending_state", "like", "{}%".format(wiz.pending_state_text))
            ],
        }
        ...
        res_ids = inv_obj.search(
            cursor, uid, search_params + [("payment_order_id", "=", False)]
        )
        values = {
