...
class TestsAutoActiva(testing.OOTestCase):
    ...
    def update_polissa_distri(self, txn):
        ...
        distri_id = cups_obj.read(cursor, uid, cups_id, ["distribuidora_id"])[
            "distribuidora_id"
        ][0]
    ...
    def switch(
        ...
        another_id = imd_obj.get_object_reference(cursor, uid, "base", "res_partner_c2c")[
            1
        ]
        ...
        cups_id = imd_obj.get_object_reference(cursor, uid, "giscedata_cups", "cups_01")[
            1
        ]
    ...
    def test_se_cierra_caso_cac_activacion_automatica_009_open(self):
        ...
        self.assertIn(
            "Informacio Adicional: 02-009: DISCONFORMIDAD CON LECTURA FACTURADA",
            last_description,
        )
        ...
        act_obj.write(
            cursor, uid, activations_ids, {"active": True, "is_automatic": True}
        )
        ...
        part_obj.search(cursor, uid, [("ref", "=", "4321")])
        ...
        with open(r1_05_xml_path, "r") as f:
            ...
            r1_05_xml = r1_05_xml.replace(
                "<Subtipo>013</Subtipo>", "<Subtipo>009</Subtipo>"
            )
    ...
    def test_import_r105_01_tancar_cac_al_finalitzar_r1(self):
        ...
        cac, r1 = self.crear_r1_i_cac_relacionats(
            ...
            cursor,
            uid,
            context={"atc_vals": {"tancar_cac_al_finalitzar_r1": True}},
        )
