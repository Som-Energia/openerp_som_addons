...
class TestMultipleCommentF1(testing.OOTestCase):
    ...
    def test__multiple_comment_to_F1__manyF1(self):
        ...
        new_comment_1 = inv_o.read(
            self.cursor, self.uid, inv_id_1, ["user_observations"]
        )["user_observations"]
        new_comment_2 = inv_o.read(
            self.cursor, self.uid, inv_id_2, ["user_observations"]
        )["user_observations"]
    ...
    def test__multiple_comment_to_F1__appendComment(self):
        ...
        inv_o.write(
            self.cursor, self.uid, inv_id, {"user_observations": "comentari test 2"}
        )
