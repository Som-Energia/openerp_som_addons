...
class TestUnlinkATC(TestSwitchingImport):
    ...
    @mock.patch.object(
        giscedata_atc_switching.giscedata_atc.GiscedataAtc, "has_r1_no_finalitzat"
    )
    def test__case_cancel_ATC_with_R102_no_finalizat__NOCancelATC(
        self, mock_has_r1_no_finalitzat
    ):
        """
        ...
        sw_obj.write(
            self.cursor, self.uid, r101.sw_id.id, {"codi_sollicitud": "201602231255"}
        )
        ...
        self.assertEqual(
            atc_e.value,
            u"Cas ATC {} no es pot cancel·lar: R1 02 l'heu de revisar i tancar".format(
                atc_id
            ),
        )
    ...
    def test__case_cancel_ATC_with_R102_finalizat__NOCancelATC(
        self, mock_has_r1_no_finalitzat
    ):
        """
    ...
    def test__case_cancel_ATC_with_R103__NOCancelATC(self):
        ...
        self.assertEqual(
            atc_e.value,
            "Cas ATC {} no es pot cancel·lar: R1 03 en estat Obert".format(atc_id),
        )
    ...
    def test__case_cancel_ATC_with_R104__NOCancelATC(self):
        ...
        self.assertEqual(
            atc_e.value,
            "Cas ATC {} no es pot cancel·lar: R1 04 en estat Pendent".format(atc_id),
        )
    ...
    def test__case_cancel_ATC_with_R105__NOCancelATC(self):
        ...
        self.assertEqual(
            atc_e.value,
            "Cas ATC {} no es pot cancel·lar: R1 05 l'heu de revisar i tancar".format(
                atc_id
            ),
        )
    ...
    def test__case_cancel_ATC_with_R108__NOCancelATC__via_import(self):
        ...
        r101 = r101_obj.browse(self.cursor, self.uid, step_id)
        sw_obj.write(
            self.cursor, self.uid, r101.sw_id.id, {"codi_sollicitud": "201607211259"}
        )
        # El creem ara perque la data sigui posterior a la posada al r101
        data_old = "<FechaSolicitud>2016-09-29T09:39:08"
        with open(r1_xml_path, "r") as f:
