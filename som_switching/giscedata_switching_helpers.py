...
class GiscedataSwitchingHelpers(osv.osv):
    ...
    def activar_polissa_from_m1_canvi_titular_subrogacio(self, cursor, uid, sw_id, old_polissa=None, context=None):
        res = super(
            GiscedataSwitchingHelpers, self
        ).activar_polissa_from_m1_canvi_titular_subrogacio(cursor, uid, sw_id, old_polissa=old_polissa, context=context)
