...
class GiscedataPolissa(osv.osv):
    ...
    def get_consum_anual_webforms(self, cursor, uid, polissa_id, context=None):
        ...
        * consum: xxx a observacions de la pólissa"""
        ...
        if (
            ...
            cadena = "* consum: "
            linia = [line for line in observacions.split("\n") if cadena in line][0]
    ...
    _columns = {
        "soci": fields.many2one(
            "res.partner", "Soci", states={"validar": [("required", True)]}
        ),
        "soci_nif": fields.related(
            "soci", "vat", type="char", string="NIF soci", readonly=True
        ),
