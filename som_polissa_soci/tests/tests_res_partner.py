...
class SomenergiaSociTests(testing.OOTestCase):
    ...
    def test__arxiva_client_mailchimp__withAddress(self, mock_mailchimp_client, mock_get_list_id, mock_archieve):
    ...
    @mock.patch("som_polissa_soci.res_partner_address.ResPartnerAddress.get_mailchimp_list_id")
    @mock.patch.object(mailchimp_marketing, "Client")
    def test__arxiva_client_mailchimp__isMember(self, mock_mailchimp_client, mock_get_list_id, mock_archieve):
