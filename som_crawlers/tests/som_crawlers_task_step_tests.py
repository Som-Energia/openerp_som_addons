...
class SomCrawlersTaskStepTests(testing.OOTestCase):
    ...
    def setUp(self):
        ...
        self.pathFileActual = os.path.join(
    ...
    def test_attach_file_ok(self):
        with Transaction().start(self.database) as txn:
            ...
            os.system('cp ' + self.pathFileActual + '/demo/anselmo_2022-07-26_15_11_GRCW_W4X151_20220726151137.zip '
                      + self.pathFileActual + '/demo/screenshots/screenshots.zip')
            ...
            self.assertTrue(self.ir_attachment.search(cursor, uid, [
                            ('name', '=', 'screenshots.zip'), ('res_model', '=', 'som.crawlers.result'), ('res_id', '=', result_id)]))
            self.assertFalse(os.path.exists(self.pathFileActual
