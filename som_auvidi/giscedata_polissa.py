            ...
            if len(sg_pol_id):
                ...
                if sg_pol_data.get('servei_generacio_id'):
                    ...
                    if servei_gen_id:
                        ...
                        if (cancels_auvidi and
                                categoria_polissa and
                                categoria_polissa[0] in polissa_current_categories):
                        ...
                        elif (current_te_auvidi and
                              categoria_polissa and
                              categoria_polissa[0] not in polissa_current_categories):
