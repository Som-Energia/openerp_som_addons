...
class InvoiceFE:
    ...
    def get_data(self, cursor, uid, wiz, invoice, context):
        ...
        result["numero_edm"] = (
            invoice.comptadors[0].name
            if invoice.comptadors
            else "Factura sense comptador associat"
        )
        ...
        for lectura in invoice.lectures_energia_ids:
            ...
            if lectura_origen_anterior == "real" and lectura_origen_actual == "real":
                ...
                lectura_origen_actual == "calculada segons CCH"
                or lectura_origen_actual == "real"
            ):
                origin = "calculada"
