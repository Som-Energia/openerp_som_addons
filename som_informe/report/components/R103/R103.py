...
class R103(ProcesR1.ProcesR1):
    ...
    def get_data(self, wiz, cursor, uid, step):
        ...
        result['tipologia_retifica'] = step.retip_tipus + " - " + \
            step.retip_subtipus_id.desc if step.retip_subtipus_id else ''
        result['hi_ha_sol_info_retip'] = step.hi_ha_sol_info_retip
        result['tipologia_sol_retip'] = step.sol_retip_tipus + " - " + \
            step.sol_retip_subtipus_id.desc if step.sol_retip_subtipus_id else ''
