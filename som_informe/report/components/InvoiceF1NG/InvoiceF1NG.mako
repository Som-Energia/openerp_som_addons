...
<li>
    ...
    <table style="width:100%;font-size:14px">
        <tr style="text-align:center;font-weight:bold">
            ...
            <td style="width:13%">${_(u"kWh compensados")}</td>
        </tr>
        % for linia in d.linies:
            <tr style="text-align:right">
                <td style="width:10%;text-align:center">${linia['origen_lectures']}</td>
                ...
                <td style="width:13%">${_(u"%s kWh") % (formatLang(linia['compensats'], digits=2))}</td>
            </tr>
        % endfor
    </table>
    <br />
