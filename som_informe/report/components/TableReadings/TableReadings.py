    ...
    def get_data(self, cursor, uid, wiz, invoice_ids, context={}):
        ...
        for invoice_id in invoice_ids:
            ...
            if invoice.type in ('in_invoice', 'in_refund'):
                ...
                if invoice.tipo_rectificadora in ('N', 'G', 'R', 'A', 'C') or (f1.type_factura == 'R' if f1 else False and invoice.ref.rectificative_type in ('N', 'G') and invoice.type == 'in_invoice'):
