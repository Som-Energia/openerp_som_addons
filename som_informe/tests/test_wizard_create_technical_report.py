...
class WizardCreateTechnicalReportTests(testing.OOTestCase):
    ...
    def test__get_data__InvoiceF1NG_invoice20TD(self):
        ...
        invoice_id = imd_obj.get_object_reference(
            cursor, uid, 'som_informe', 'factura_0067'
        )[1]
        ctx = {
            'active_id': polissa_id, 'active_ids': [polissa_id],
        }
        ...
        self.assertEqual(result, {'invoice_type': u'N',
            'date_from': '15-08-2021', 'amount_base': 10.0,
            'invoice_date': '01-10-2021', 'invoiced_days': 32,
            'date_to': '15-09-2021', 'date': '2021-10-01',
            'invoice_number': u'12345678', 'numero_edm': u'004007',
    ...
    def test__get_data__InvoiceF1NG_invoice30TD(self):
        ...
        invoice_id = imd_obj.get_object_reference(
            cursor, uid, 'som_informe', 'factura_0068_30TD'
        )[1]
        ctx = {
            'active_id': polissa_id, 'active_ids': [polissa_id],
        }
        ...
        self.assertEqual(result, {'invoice_type': u'N',
            'date_from': '15-08-2021', 'amount_base': 10.0,
            'invoice_date': '16-09-2021', 'invoiced_days': 32,
            'date_to': '15-09-2021', 'date': '2021-09-16',
            'invoice_number': u'12345679', 'numero_edm': u'004008',
            'type': 'InvoiceF1NG', 'invoiced_energy': 1.0,
            'amount_total': 10.0})
