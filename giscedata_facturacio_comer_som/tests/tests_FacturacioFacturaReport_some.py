...
class Tests_FacturacioFacturaReport_fill_and_find(Tests_FacturacioFacturaReport_base):
    ...
    def test__get_report_data__cross_test_more_sample(self):
        ...
        result1 = self.r_obj.get_components_data(
            self.cursor, self.uid, [f_id1, f_id2], ctxt)
    ...
    def test__find_all_components_data__detect_some_of_them(self):
        ...
        self.assertEquals(methods['logo'].im_class.__name__,
        ...
        self.assertEquals(methods['company'].im_class.__name__,
                          'giscedata.facturacio.factura.report')
...
class Tests_FacturacioFacturaReport_invoice_details_generation(Tests_FacturacioFacturaReport_base):
    ...
    def test__som_report_comp_invoice_details_generation__without_generation_lines(self, te_autoconsum_mock_function, get_autoconsum_excedents_product_id_mock_function):
        ...
        result = self.r_obj.get_component_invoice_details_generation_data(
            **self.bfp(f_id))
...
class Tests_FacturacioFacturaReport_invoice_details_other_concepts(Tests_FacturacioFacturaReport_base):
    ...
    def test__som_report_comp_invoice_details_other_concepts__without_other_lines(self, get_lines_in_extralines_mock_function):
        ...
        result = self.r_obj.get_component_invoice_details_other_concepts_data(
            **self.bfp(f_id))
...
class Tests_FacturacioFacturaReport_partner_info(Tests_FacturacioFacturaReport_base):
    ...
    def test__som_report_comp_partner_info(self):
        ...
        partner_bank_id = self.partner_bank_obj.search(
...
class Tests_FacturacioFacturaReport_invoice_details_td(Tests_FacturacioFacturaReport_base):
    ...
    def test__get_sub_component_invoice_details_td_power_tolls_data_dummy(self, get_tarifa_elect_atr_mock_function):
        ...
        result = self.r_obj.get_sub_component_invoice_details_td_power_tolls_data(
            **self.bfp(f_id))
    ...
    def test__get_sub_component_invoice_details_td_data_4_power_lines_2_periods_2_blocks(self, get_atr_price_mock_function, is_2XTD_mock_function):
        ...
        result = self.r_obj.get_sub_component_invoice_details_td_power_data(
            **self.bfp(f_id))
