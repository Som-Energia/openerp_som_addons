...
<td class="td_text">
    ...
    % if id_info.has_mag:
        ...
        <br>
        ${_(u"Preu mitjà del Mecanisme d'Ajust el darrer mes natural complet (%s) ha estat de %s €/kWh, segons estableix el RD-L 18/2022.") % (mes_text, formatLang(id_info.preu_mitja_mag_darrer_mes))}
        <br>
