<%page args="id" />
<style>
<%include file="invoice_details_td_otl.css" />
</style>
...
<table id="invoice_detail_td">
    ...
    <%include file="/giscedata_facturacio_comer_som/report/components/invoice_details_td_otl_other_concepts/invoice_details_td_otl_other_concepts.mako" args="id=id.other_concepts" />
