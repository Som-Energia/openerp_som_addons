<%
    ...
    partner = objects[0]
    data = partner.report_liquidacions_unificat_data()
...
<body>
    ...
    <div class="fila">
        ...
        <!-- 150px mida logo -->
        <img src="${addons_path}/som_inversions/report/logo_som2.png" alt="Logo Som Energia" width="150" height="75" /></a><br>
    ...
    %for number, invoice in data['invoices'].iteritems():
        ...
        <div class="TitolCaixa">
            <h2>${_(u"LIQUIDACIÓ INTERESSOS")} ${invoice['name']}</h2>
        </div>
        <div class="CaixaFons">
        ...
        %for line in invoice['lines']:
            ...
            <div class="CaixaDades">
                <p class="ContingutDades numeracio">${formatLang(invoice['amount_untaxed'], monetary=True)} €
                </p>
            </div>
            <div class="CaixaEspai">
            </div>
            ...
            <div class="CaixaDades">
                <p class="ContingutDades numeracio"><b>${formatLang(invoice['to_pay_total'],monetary=True)} €</b>
                </p>
            </div>
            <div class="CaixaEspai">
            </div>
