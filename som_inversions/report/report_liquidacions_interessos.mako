<%
    ...
    inv = objects[0]
    data = inv.report_liquidacions_data()
    total_invested_apos = 0
    last_inv_line = data.lines[len(data.lines)-1]
    last_inv_line_date = str(datetime.strptime(last_inv_line.date_end, "%d/%m/%Y").date())
    if last_inv_line_date == inv.date_invoice:
        total_invested_apos = last_inv_line.quantity
...
<body>
    ...
    <div class="fila">
        ...
        <div class="caixaHeader">
            ...
            <div class="esquerra">
                <p class="ContingutDades">
                    ${_(u"Aportacions voluntàries al capital social")}<br/>
    ...
    <div class="contingutTXT">
            ...
            <p>${_(u"Actualment les teves aportacions voluntàries al capital social de SOM ENERGIA SCCL sumen")}   <b>${formatLang(total_invested_apos ,monetary=True)} €</b>. </p>
