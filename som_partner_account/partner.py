...
class ResPartner(osv.osv):
    ...
    def create_account(self, cursor, uid, ids, acc_code, acc_type, user_type,
                       code_gen, context=None):
        ...
        if account:
            ...
            raise osv.except_osv(_('Error'),
                                 _(u"No s'ha trobat el compte pare"))
        ...
        for partner in self.browse(cursor, uid, ids):
            ...
            if found:
                ...
                res[str(partner.id)] = account_obj.create(cursor, uid, vals,
                                                          context)
        return res

    def generate_acc_code_43(self, cursor, uid, ids, parent_id=None,
                             context=None):
        ...
        if not isinstance(ids, list):
            ids = [ids]
        parent = account_obj.read(cursor, uid, parent_id,
                                  ['code', 'parent_id'])
        grandparent = account_obj.read(cursor, uid, parent['parent_id'][0],
                                       ['code'])
    ...
    def generate_acc_code_410(self, cursor, uid, ids, parent_id=None,
                              context=None):
    ...
    def create_account_43(self, cursor, uid, ids, context=None):
        ...
        if not context:
            context = {}
        return self.create_account(cursor, uid, ids, '4300',
                                   'receivable', 'terceros - rec',
                                   self.generate_acc_code_43, context)
    ...
    def create_account_410(self, cursor, uid, ids, context=None):
        ...
        if not context:
            context = {}
        return self.create_account(cursor, uid, ids, '4100', 'payable',
                                   'terceros - pay',
                                   self.generate_acc_code_410, context)
    ...
    def create_account_163(self, cursor, uid, ids, context=None):
        ...
        if not context:
            context = {}
        return self.create_account(cursor, uid, ids, '163', 'other', 'capital',
                                   self.generate_acc_code_163, context)
    ...
    def create_account_1714(self, cursor, uid, ids, context=None):
        ...
        if not context:
            context = {}
        return self.create_account(cursor, uid, ids, '1714', 'other',
                                   'capital', self.generate_acc_code_1714,
                                   context)
    ...
    def create_account_1635(self, cursor, uid, ids, context=None):
        ...
        if not context:
            context = {}
        return self.create_account(cursor, uid, ids, '1635', 'other',
                                   'capital', self.generate_acc_code_1635,
                                   context)
    ...
    def button_assign_acc_43(self, cursor, uid, ids, context=None):
        ...
        for partner_id in res:
            self.write(cursor, uid, int(partner_id),
                       {'property_account_receivable': res[partner_id]})
        return True
    ...
    def button_assign_acc_1714(self, cursor, uid, ids, context=None):
        ...
        for partner_id in res:
            self.write(cursor, uid, int(partner_id),
                       {'property_account_titols': res[partner_id]})
        return True
    ...
    def become_member(self, cursor, uid, id, context=None):
        ...
        if soci_ids:
            soci_id = soci_ids[0]
            soci = soci_obj.read(cursor, uid, soci_id, [
                'data_baixa_soci',
                'comment',
            ])
            newcomment = (
    ...
    def adopt_contracts_as_member(self, cursor, uid, partner_id, context=None):
        ...
        contract_ids = contract_obj.search(cursor, uid, [
            '|',
            ('titular', '=', partner_id),
            ('pagador', '=', partner_id),
        ])
