...
class SomAutoreclamaState(osv.osv):
    ...
    def _ff_generate_atc_parameters(self, cursor, uid, ids, field_name, arg, context=None):
        ...
        for import_vals in self.read(cursor, uid, ids, ["generate_atc_parameters"]):
            res[import_vals["id"]] = json.dumps(import_vals["generate_atc_parameters"], indent=4)
        return res
    ...
    _columns = {
        ...
        "is_last": fields.boolean(string=_(u"Últim"), help=_(u"Indica si es l'utim estat")),
        ...
        "active": fields.boolean(
            string=_(u"Actiu"), help=_(u"Indica si l'estat està actiu i pot executar la tasca")
        ),
