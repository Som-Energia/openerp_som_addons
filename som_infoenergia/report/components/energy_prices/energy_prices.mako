...
<p class="center"><b>${_(u"PH = 1,015 * [(PHM + Pc + SobrecostosREE + Interrump + P<sub>OsOm</sub>) (1 + Perd) + FE + K] + PA + CA")}</b></p>
<p>${_(u"On:")}</p>
<ul>
    ...
    <li>${_("<b>P<sub>OsOm</sub></b> = Cost de l’Operador del sistema (REE) i de l’Operador del Mercat (OMIE).")}</li>
