...
class WizardSendReports(osv.osv_memory):
    ...
    _columns = {
        ...
        "email_subject": fields.char(
            "Assumpte correu", size=200, help="Assumpte que substituirà el de la plantilla"
        ),
        "allow_reenviar": fields.boolean(
            "Reenviar correus ja enviats", help=_(u"Permetre que es reenviïn correus ja enviats?")
        ),
