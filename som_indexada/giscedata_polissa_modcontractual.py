...
class GiscedataPolissaModcontractual(osv.osv):
    ...
    def _do_previous_actions_on_activation(self, cursor, uid, mc_id, context=None):
        res = super(
            GiscedataPolissaModcontractual, self
        )._do_previous_actions_on_activation(cursor, uid, mc_id, context)
        ...
        if (
            ...
            and (
                modcon.mode_facturacio == "index"
                and modcon.modcontractual_ant.mode_facturacio != "index"
            )
        ):
