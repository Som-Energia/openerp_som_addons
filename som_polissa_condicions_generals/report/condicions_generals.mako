...
<section class="wpb-content-wrapper"><div class="a13_row_container" style="background-position:top left;background-repeat: no-repeat;"><div class="wpb_row vc_row-fluid "><div class="wpb_column vc_column_container vc_col-sm-2"><div class="vc_column-inner vc_custom_1551863571093"><div class="wpb_wrapper"></div></div></div><div class="wpb_column vc_column_container vc_col-sm-8 vc_col-has-fill"><div class="vc_column-inner vc_custom_1551863815583"><div class="wpb_wrapper">
	<div class="wpb_text_column wpb_content_element ">
		<div class="wpb_wrapper">
			<p>SOM ENERGIA, SCCL, és una societat cooperativa de persones consumidores i usuàries, sense afany de lucre, inscrita al Registre de Cooperatives de Catalunya i subjecta als principis i disposicions de la Llei 12/2015, de 9 de juliol, de cooperatives, que té per objecte principal la comercialització i producció d’energia elèctrica i calorífica provinent de fonts renovables.</p>
<p>SOM ENERGIA SCCL es troba inscrita al registre de comercialitzadores d’energia elèctrica amb el codi R2-415. Té el domicili social a C/ Pic de Peguera, 11, 17003-Girona, i el seu web corporatiu és www.somenergia.coop.</p>
...
<li>
<h4><a href="#autoritzacio-d-acces-a-la-xarxa-al-comercialitzador">AUTORITZACIÓ D’ACCÉS A LA XARXA A LA COMERCIALITZADORA</a></h4>
</li>
<li>
...
<li>
<h4><a href="#codi-etic-i-model">CODI ÈTIC I MODEL DE PREVENCIÓ DE DELICTES</a></h4>
</li>
<li>
...
<p class="sagnia">1.5 L’incompliment o falta de veracitat d’aquesta obligació poden ser considerats causa de resolució del present contracte per part de SOM ENERGIA, SCCL. La contractant declara que totes les dades personals proporcionades a SOM ENERGIA, SCCL, són veraces i es compromet expressament a mantenir-les actualitzades. La contractant s’ha d’assegurar especialment que tant les adreces facilitades a efectes de notificacions com el CUPS són correctes, ja que SOM ENERGIA, SCCL, no té manera de comprovar-ne la veracitat. En cas que la contractant faciliti a SOM ENERGIA, SCCL, una adreça o un CUPS erronis, és la contractant l’única responsable dels danys que aquesta situació pugui generar, incloent-hi els derivats de la modificació involuntària del subministrament contractat per tercers.</p>
	...
	<div class="wpb_text_column wpb_content_element ">
		<div class="wpb_wrapper">
			<p class="sagnia">2.1 Per electricitat 100 % renovable s’entén el fet que SOM ENERGIA, SCCL, es compromet a adquirir les garanties d’origen necessàries que acreditin que la mateixa quantitat de megawatts-hora comercialitzada anualment ha estat generada a partir de fonts d’energia renovables. Per tant, s’haurà injectat a la xarxa tanta electricitat provinent d’instal·lacions productores d’origen renovable en una quantitat equivalent al consum elèctric de la contractant.</p>
<p class="sagnia">2.2 Instal·lacions productores d’electricitat d’origen renovable són aquelles que obtenen l’energia de fonts naturals virtualment inesgotables.</p>
<p class="sagnia">2.3 El procediment formal que SOM ENERGIA, SCCL, utilitza per certificar l’electricitat són els certificats de garantia d’origen emesos per la CNMC (Comissió Nacional dels Mercats i la Competència).</p>
<p class="sagnia">2.4 El balanç entre energia produïda i energia consumida es duu a terme anualment.</p>

		</div>
	</div>
</div></div></div></div></div><div class="a13_row_container" style="background-position:top left;background-repeat: no-repeat;"><div class="wpb_row vc_row-fluid "><div class="wpb_column vc_column_container vc_col-sm-12" id="formalitzacio-i-durada"><div class="vc_column-inner vc_custom_1551786701714"><div class="wpb_wrapper">
...
<p class="dinssagnia">Una vegada acabat el contracte de subministrament, SOM ENERGIA, SCCL, retornarà a la contractant la garantia rebuda dins del termini comprès entre els seixanta (60) dies comptats des de la domiciliació de l’última factura, i mitjançant transferència al compte bancari indicat. SOM ENERGIA, SCCL, es reserva la facultat de retenir-la per l’import de tots aquells pagaments no satisfets, així com les quantitats resultants de qualsevol altre incompliment per part de la contractant.</p>
	...
	<div class="wpb_text_column wpb_content_element ">
		<div class="wpb_wrapper">
			<p class="sagnia">4.1 La contractant ha de disposar al punt de subministrament d’un equip de control i mesura del subministrament d’electricitat (“equip de mesura i control”), bé de propietat o bé de lloguer, que ha de complir amb els requisits tècnics i de seguretat exigits per la regulació vigent. La contractant és la responsable de la custòdia, ús correcte i no manipulació de l’equip de mesura i control, així com del manteniment en cas de ser-ne la propietària.</p>
<p class="sagnia">4.2 La contractant es compromet a no manipular l’equip de mesura i control, i informar a SOM ENERGIA, SCCL, i/o a l’empresa distribuïdora en cas que detecti un funcionament anormal de l’equip de mesura i control o incidències en aquest.</p>
<p class="sagnia">4.3 En cas que la contractant disposi d’un equip de mesura i control de lloguer, tant el règim com el preu d’aquest seran els establerts per l’empresa distribuïdora en compliment de la normativa vigent.</p>
...
<p class="dinssagnia">La informació actualitzada sobre el preu i les tarifes aplicables han de romandre a disposició de la contractant al web corporatiu de SOM ENERGIA, SCCL, (<a href="https://www.somenergia.coop" target="_blank" rel="noopener">www.somenergia.coop</a>), així com en el contracte subscrit i vigent en cada moment.</p>
<p class="sagnia">5.4 Qualsevol cost derivat d’actuacions a l’equip de mesura i control o a les instal·lacions de la contractant ha de ser assumit exclusivament per aquesta o per l’empresa distribuïdora, segons estableixi la normativa vigent.</p>
<p class="sagnia">5.5 En cas de mal funcionament dels equips de mesura o error administratiu cal atenir-se al que disposa l’article 96 del Reial decret 1955/2000 o la normativa que el substitueixi.</p>

		</div>
	</div>
</div></div></div></div></div><div class="a13_row_container" style="background-position:top left;background-repeat: no-repeat;"><div class="wpb_row vc_row-fluid "><div class="wpb_column vc_column_container vc_col-sm-12" id="autoritzacio-d-acces-a-la-xarxa-al-comercialitzador"><div class="vc_column-inner vc_custom_1551786759329"><div class="wpb_wrapper">
	<div class="wpb_text_column wpb_content_element  vc_custom_1695822511926">
		<div class="wpb_wrapper">
			<h2>6. AUTORITZACIÓ D’ACCÉS A LA XARXA A LA COMERCIALITZADORA <span class="pujar">– <a href="#top">Pujar a l’índex&nbsp;↑</a></span></h2>
...
</div></div></div></div></div><div class="a13_row_container" style="background-position:top left;background-repeat: no-repeat;"><div class="wpb_row vc_row-fluid "><div class="wpb_column vc_column_container vc_col-sm-12" id="autoconsum"><div class="vc_column-inner vc_custom_1563546176980"><div class="wpb_wrapper">
	<div class="wpb_text_column wpb_content_element  vc_custom_1563546158919">
		<div class="wpb_wrapper">
			<h2>8. AUTOCONSUM&nbsp;<span class="pujar">– <a href="#top">Pujar a l’índex&nbsp;↑</a></span></h2>

		</div>
	</div>
</div></div></div></div></div><div class="a13_row_container" style="background-position:top left;background-repeat: no-repeat;"><div class="wpb_row vc_row-fluid "><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner vc_custom_1563546198586"><div class="wpb_wrapper">
	<div class="wpb_text_column wpb_content_element ">
		<div class="wpb_wrapper">
			<p class="sagnia">8.1 Alta de l’autoconsum</p>
...
<p class="sagnia">SOM ENERGIA, SCCL, pot modificar les condicions d’aquest descompte en qualsevol moment, comunicant-ho a la contractant amb un preavís de trenta (30) dies naturals d’antelació, sense perjudici de l’import de Sols pendents d’aplicació, que es mantindran en els termes previstos en aquestes condicions generals.</p>
	...
	<div class="wpb_text_column wpb_content_element ">
		<div class="wpb_wrapper">
			<p class="sagnia">9.1 Les parts estan obligades al compliment de les obligacions reflectides al contracte, d’acord amb els termes que s’hi recullen.</p>
<p class="sagnia">9.2 Sense perjudici de l’anterior, el contracte actual pot ser modificat per SOM ENERGIA, SCCL, per decisió del Consell Rector o de l’Assemblea de sòcies. Tota modificació s’ha de comunicar degudament a la contractant, d’acord amb el que preveu aquesta clàusula, i poden ser motivades a fi de complir amb la normativa del mercat elèctric, així com per la fixació de criteris sobre els valors que desitja transmetre la cooperativa.</p>
<p class="sagnia">9.3 Igualment, SOM ENERGIA, SCCL, pot modificar el contracte en cas que demostri que, per alteracions dels mercats de l’electricitat o qualsevol altra circumstància, el compliment de les prestacions contractuals resulta excessivament onerós.</p>
<p class="sagnia">9.4 Aquestes modificacions s’han de comunicar a la contractant amb una antelació de trenta (30) dies naturals a l’aplicació de la modificació i, en cas que suposin un increment del preu, la contractant pot resoldre el contracte comunicant-ho a SOM ENERGIA, SCCL, per qualsevol dels mitjans establerts en el contracte actual en el termini de quinze (15) dies naturals següents a aquesta comunicació. En cas de no resoldre el contracte en aquest termini, la modificació s’entén acceptada per la contractant.</p>
<p class="sagnia">9.5 La contractant podrà sol·licitar a SOM ENERGIA, SCCL, la modificació del seu contracte a través dels formularis establerts al web. En cas que la modificació sol·licitada afecti el contracte d’accés a xarxa, formalitzat entre la contractant i l’empresa distribuïdora propietària d’aquesta xarxa, SOM ENERGIA, SCCL, farà els seus millors esforços perquè la distribuïdora tramiti i activi aquesta modificació. En cas que la contractant hagi sol·licitat una modificació de la tarifa contractada amb SOM ENERGIA, SCCL, la contractant no podrà fer cap altra sol·licitud fins que el canvi de tarifa s’activi (en el cicle de facturació següent). No serà possible sol·licitar una modificació de tarifa fins que s’activi qualsevol sol·licitud feta prèviament que afecti el contracte d’accés a xarxa i que encara no hagi estat activada per part de l’empresa distribuïdora.</p>

		</div>
	</div>
</div></div></div></div></div><div class="a13_row_container" style="background-position:top left;background-repeat: no-repeat;"><div class="wpb_row vc_row-fluid "><div class="wpb_column vc_column_container vc_col-sm-12" id="traspas"><div class="vc_column-inner vc_custom_1551786813571"><div class="wpb_wrapper">
	<div class="wpb_text_column wpb_content_element  vc_custom_1563546811005">
		<div class="wpb_wrapper">
			<h2>10. TRASPÀS <span class="pujar">– <a href="#top">Pujar a l’índex&nbsp;↑</a></span></h2>
...
<li>Derivacions per subministrament d’energia a una instal·lació no prevista al contracte.</li>
<li>Manipulació de l’equip de mesura i control, o prevenció del seu funcionament correcte.</li>
...
<p class="sagnia">11.3 Comunicació de la suspensió. SOM ENERGIA, SCCL, ha de comunicar a la contractant la suspensió del subministrament, d’acord amb els terminis i procediments establerts en la legislació vigent, llevat dels supòsits d), e), f) i g) anteriors, en els quals la suspensió del subministrament es pot dur a terme quan aquests ocorrin.</p>
<p class="sagnia">11.4 Reposició del subministrament. El subministrament no es restaurarà fins que s’hagi resolt la situació motiu de la suspensió i s’hagi satisfet, per part de la contractant, la totalitat de la quantitat pendent de pagament, així com la totalitat d’interessos acumulats fins a la data, així com els imports que corresponguin en concepte de desconnexió i reconnexió del subministrament. SOM ENERGIA, SCCL, pot exigir a la contractant la presentació d’una garantia en forma de fiança i aval bancari com a condició per a la reposició del subministrament, que s’ha de reemborsar després de la finalització del contracte. Aquesta garantia pot ser d’un valor equivalent a la facturació de tres (3) mesos naturals a preus de la tarifa objecte de contractació. Les condicions d’execució i devolució d’aquesta garantia s’estableixen a la clàusula 3.8.</p>
<p class="sagnia">11.5 El que es preveu en la present clàusula s’estableix sense perjudici del dret de SOM ENERGIA, SCCL, de resoldre el contracte actual d’acord amb la clàusula 12 ni de les especialitats previstes per als subministraments essencials conforme a la normativa vigent.</p>
<p class="sagnia">11.6 Alternativament a ordenar la suspensió del subministrament, SOM ENERGIA, SCCL, pot, en cas d’incompliment del contracte actual per part de la contractant, i si així ho estimés oportú donades les circumstàncies, resoldre el contracte actual de manera que la contractant passi a tenir la seva relació contractual amb la comercialitzadora de referència d’acord amb els procediments establerts en la legislació vigent.</p>

		</div>
	</div>
</div></div></div></div></div><div class="a13_row_container" style="background-position:top left;background-repeat: no-repeat;"><div class="wpb_row vc_row-fluid "><div class="wpb_column vc_column_container vc_col-sm-12" id="finalitzacio"><div class="vc_column-inner vc_custom_1551786849026"><div class="wpb_wrapper">
	<div class="wpb_text_column wpb_content_element  vc_custom_1563546827340">
		<div class="wpb_wrapper">
...
<li>En cas d’impagament de les factures emeses transcorreguts 5 dies de la data de pagament, sense perjudici de l’aplicació dels interessos de demora previstos a la clàusula 7, i sempre en els terminis i amb els requisits establerts a la normativa aplicable.</li>
...
<p class="sagnia">12.4 En cas de finalització per impagament, SOM ENERGIA, SCCL, pot exigir a la persona titular del contracte la satisfacció dels deutes pendents, i és una mesura transitòria la utilització del capital social aportat a SOM ENERGIA, SCCL, en els casos que sigui sòcia. Si es produeix aquest cas, el capital social ha de ser reintegrat abans de quinze (15) dies des de la seva utilització. El Consell Rector o, si escau, l’òrgan en qui aquest delegui d’acord amb els estatuts i la legislació vigent, ha d’estudiar en cada cas i, si ho considera oportú, aplicar el règim de faltes i sancions recollides als estatuts de SOM ENERGIA, SCCL.</p>

		</div>
	</div>
</div></div></div></div></div><div class="a13_row_container" style="background-position:top left;background-repeat: no-repeat;"><div class="wpb_row vc_row-fluid "><div class="wpb_column vc_column_container vc_col-sm-12" id="responsabilitat"><div class="vc_column-inner vc_custom_1551786921145"><div class="wpb_wrapper">
	<div class="wpb_text_column wpb_content_element  vc_custom_1563546836373">
		<div class="wpb_wrapper">
...
<p class="sagnia">15.2 En el marc de l’execució del subministrament contractat està prevista la cessió de dades, procedents de la mateixa persona interessada, a terceres empreses quan sigui necessari per a la prestació dels serveis contractats, tals com, per exemple, assessories fiscals i comptables, bancs i caixes, administració tributària o altres administracions públiques, empreses distribuïdores, empreses de recobrament d’impagats, registres de morositat i tercers països.</p>
<p class="sagnia">15.3 La contractant té dret a accedir, rectificar i suprimir les dades, així com altres drets, indicats en la informació addicional que figura <a href="https://www-test.somenergia.coop/ca/avis-legal/#politica-de-privacitat" target="_blank" rel="noopener">a la Política de Privacitat de SOM ENERGIA, SCCL, disponible al seu espai web d’internet www.somenergia.coop</a> i que pot exercir els drets o trobar la informació addicional dirigint-se a l’adreça de SOM ENERGIA, SCCL, d’acord amb el que indica la clàusula 16.</p>

		</div>
	</div>
</div></div></div></div></div><div class="a13_row_container" style="background-position:top left;background-repeat: no-repeat;"><div class="wpb_row vc_row-fluid "><div class="wpb_column vc_column_container vc_col-sm-12" id="notificacions-i-reclamacions"><div class="vc_column-inner vc_custom_1551786977172"><div class="wpb_wrapper">
	<div class="wpb_text_column wpb_content_element  vc_custom_1563546863835">
		<div class="wpb_wrapper">
	...
	<div class="wpb_text_column wpb_content_element ">
		<div class="wpb_wrapper">
			<p class="sagnia">16.1 La contractant designa a l’efecte de notificacions les adreces de correu electrònic i postal indicada per ella en el moment de la contractació i recollides a les condicions particulars, obligant-se a comunicar a SOM ENERGIA, SCCL, qualsevol modificació que s’hi produeixi.</p>
<p class="sagnia">16.2 Les parts acorden que la notificació de les factures, així com altres informacions de caràcter informatiu general, s’han de fer prioritàriament per correu electrònic a l’adreça recollida a les condicions particulars. El manteniment correcte d’aquest correu és responsabilitat de la contractant.</p>
<p class="sagnia">16.3 La contractant pot contactar i, si s’escau, formular reclamacions a SOM ENERGIA, SCCL, per tots els canals de comunicació establerts per a això i permanentment actualitzats al seu web corporatiu <a href="https://www.somenergia.coop" target="_blank" rel="noopener">www.somenergia.coop</a> (<a href="https://ca.support.somenergia.coop/article/470-com-puc-contactar-amb-la-cooperativa-mail-telefon-etc" target="_blank" rel="noopener">https://ca.support.somenergia.coop/article/470-com-puc-contactar-amb-la-cooperativa-mail-telefon-etc</a>), en particular:</p>
<ul>
<li>Per correu electrònic dirigit a <a href="mailto:info@somenergia.coop" alt="Enviar un correu">info@somenergia.coop</a></li>
<li>Per correu postal dirigit a l’adreça:<br>
<em>Parc Científic i Tecnològic de la UDG. Edifici Giroemprèn.<br>
C / Pic de Peguera, 11 17003 Girona</em></li>
<li>Via formulari electrònic: <a href="https://ca.support.somenergia.coop" target="blank" rel="noopener">https://ca.support.somenergia.coop</a> – Contacte</li>
<li>Per telèfon al número gratuït: <a href="tel:900103605" target="_blank" rel="noopener">900 103 605</a> o bé al <a href="tel:872202550" target="_blank" rel="noopener">872.202.550</a></li>
</ul>
<p class="sagnia">16.4 SOM ENERGIA, SCCL, presta els seus serveis de dilluns a divendres en horari laboral (de 9 a 17 hores, excepte festius a la ciutat de Girona). Dins d’aquest horari, l’atenció telefònica està disponible de 9 a 14 hores.</p>

		</div>
	</div>
</div></div></div></div></div><div class="a13_row_container" style="background-position:top left;background-repeat: no-repeat;"><div class="wpb_row vc_row-fluid "><div class="wpb_column vc_column_container vc_col-sm-12" id="codi-etic-i-model"><div class="vc_column-inner vc_custom_1551787013536"><div class="wpb_wrapper">
	...
	<div class="wpb_text_column wpb_content_element ">
		<div class="wpb_wrapper">
			<p class="sensesagnia">SOM ENERGIA, SCCL, compta amb un Codi Ètic en el qual s’inclouen els nostres valors i la nostra tolerància zero cap a la corrupció, que és accessible a la nostra pàgina en internet (<a href="http://www.somenergia.coop/es/quienes-somos/#documentacion" target="_blank" rel="noopener">www.somenergia.coop/es/quienes-somos/#documentacion</a>); així mateix, tenim implantat un model de prevenció de delictes adaptat a la nostra realitat, sota control i supervisió del Comitè d’Ètica, que és base del foment de la cultura ètica i d’integritat de la cooperativa. Aquest Codi inclou els mecanismes que la contractant té a la seva disposició per posar en coneixement de SOM ENERGIA, SCCL, qualsevol incompliment d’aquest, així com qualsevol conducta inadequada o infractora de lleis o reglaments.</p>
<p class="sensesagnia">SOM ENERGIA espera dels proveïdors i tercers amb qui contractem el compromís i compliment dels estàndards de comportament fixats al Codi Ètic; especialment, esperem un compromís de tolerància zero cap al delicte i, en particular, cap a qualsevol forma de corrupció.</p>

		</div>
	</div>
</div></div></div></div></div><div class="a13_row_container" style="background-position:top left;background-repeat: no-repeat;"><div class="wpb_row vc_row-fluid "><div class="wpb_column vc_column_container vc_col-sm-12" id="legislacio-i-jurisdiccio"><div class="vc_column-inner vc_custom_1551787013536"><div class="wpb_wrapper">
	<div class="wpb_text_column wpb_content_element  vc_custom_1563546873116">
		<div class="wpb_wrapper">
