...
<h3>5. ADAPTACIÓ DE LA CLÀUSULA 5 “PREU I ACTUALITZACIÓ”</h3>
    ...
    <ul>
        ...
        <li>
            <p><strong>PHMA </strong>= Preu horari del mecanisme d'ajust als costos de producció d'electricitat mitjançant el gas regulat pel Reial decret llei 10/2022, de 13 de maig, pel qual s'estableix amb caràcter temporal un mecanisme d'ajust de costos de producció per a la reducció del preu de l'electricitat en el mercat majorista.</p>
            <p>Aquest concepte no és aplicable per al Sistema Elèctric Insular (Canàries, Balears).</p>
            <p>Península: <a href="https://www.omie.es/es/market-results/daily/average-final-prices/hourly-price-consumers?scope=daily&amp;date=2022-06-15"><em>https://www.omie.es/es/market-results/daily/average-final-prices/hourly-price-consumers?scope=daily</em></a></p>
        </li>
        <li>
        ...
        <li>
            <p><strong>I</strong> = Cost del servei d’interrompibilitat regulat pel Ministeri a cada moment.</p>
        </li>
        <li>
    ...
    <p>Y, <em>h</em><sub><em>i</em></sub> representa cadascuna de les hores del període de facturació en qüestió.</p>
