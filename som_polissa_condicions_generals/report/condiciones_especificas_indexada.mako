...
<h3>5. ADAPTACIÓN DE LA CLÁUSULA 5 “PRECIO Y ACTUALIZACIÓN”</h3>
    ...
    <p style="padding-left: 40px"><strong>PH = 1,015 * [(PHM + Pc + Sc + Dsv + GdO + P<sub>OsOm</sub>) (1 + Perd) + FE + F] + PTD + CA</strong></p>
    ...
    <ul>
        ...
        <li>
        <p><strong>PHM</strong> = Precio horario del mercado diario. Para los contratos de la península es el precio publicado por el Operador del Mercado Ibérico de la Energía (OMIE), mientras que para las islas Baleares y Canarias es el precio de la demanda del Sistema Eléctrico Insular.</p>
        ...
        <li>
        <p><strong>Sc</strong> = Sobrecostes diarios publicados por Red Eléctrica Española (REE) para la gestión de la red, según el valor publicado en el momento de generar la factura. </p>
        </li>
        <li>
        ...
        <ul>
        <li>
        <p>Dsv = [1/2  (CoDsvSu + CoDsvBa) + BS3 + RAD3] x Factor Desvío</p>
        </li>
        <li>
        ...
        <li>
        <strong>GdO</strong> = Coste de adquisición de los certificados de Garantía de Origen Renovable de la electricidad. Este coste dependerá de la energía producida por las plantas de SOM ENERGIA, SCCL y del coste de adquisición de los certificados de Garantía de Origen Renovable. Al no tratarse de un coste regulado, depende de las condiciones acordadas con los proveedores de certificados. Este coste se actualizará trimestralmente y será informado en la web de SOM ENERGIA, SCCL
        </li>
        <li>
        <p><strong>P</strong><sub><strong>OsOm</strong></sub><strong> </strong>= Coste del operador del sistema (REE) y de OMIE, establecido por la Comisión Nacional de los Mercados y la Competencia (CNMC). El coste de OMIE no se aplica a los contratos del sistema eléctrico insular (Canarias, Baleares).</p>
        </li>
        <li>
    ...
    <p style="padding-left: 40px">
        <strong>Importe Compensación excedentes = SUMA HORARIA (kWh excedentarios </strong><em><strong>h</strong></em><sub><em><strong>i</strong></em></sub><em><strong> </strong></em><strong>x PHC </strong><em><strong>h</strong></em><sub><em><strong>i</strong></em></sub>)
    </p>
    <p>Y, <em>h<sub>i</sub></em> representa cada una de las horas del periodo de facturación en cuestión.</p>

    <p>Donde, PHC representa el precio horario de compensación de excedentes que, para los contratos de la península, es el precio de OMIE, mientras que para las Baleares y Canarias es el precio horario de la demanda del Sistema Eléctrico Insular (balear y canario, respectivamente) menos el precio que deben aportar los excedentes insulares por los costes de servicios de ajuste  en la operación del sistema.</p>

    <p>
    PHC península = Precio OMIE<br>
