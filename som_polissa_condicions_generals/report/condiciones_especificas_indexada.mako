...
<h3>5. ADAPTACIÓN DE LA CLÁUSULA 5 “PRECIO Y ACTUALIZACIÓN”</h3>
    ...
    <ul>
        ...
        <li>
        <p><strong>PHMA </strong>= Precio horario del mecanismo de ajuste a los costes de producción de electricidad mediante el gas regulado en el Real Decreto-Ley 10/2022, de 13 de mayo, por el que se establece con carácter temporal un mecanismo de ajuste de costes de producción para la reducción del precio de la electricidad en el mercado mayorista. </p>
        </li>
        <p>Este concepto no es de aplicación para el Sistema Eléctrico Insular (Canarias, Baleares).</p>
        ...
        <li>
        <p><strong>I</strong> = Coste del servicio de interrumpibilidad regulado por el Ministerio en cada momento.</p>
        </li>
        <li>
    ...
    <p>Y, <em>h</em><sub><em>i</em></sub> representa cada una de las horas del periodo de facturación en cuestión.</p>
...
<p>En Girona, a [fecha de contratación online del producto, o, si no es posible por limitaciones del ERP, fecha de emisión de las condiciones específicas]</p>
