...
<h3>2. OBJECTE</h3>
    ...
    <p>
        En el cas que s’aculli a la modalitat d’autoconsum amb excedents sense compensació simplificada, la Contractant assumeix i entén que l’energia produïda per la Instal·lació i que no és consumida durant l’horari associat al CUPS no es pot considerar energia horària autoconsumida, i, per tant, correspon exclusivament a la gestora i titular de la instal·lació tant la seva propietat, com la seva valoració, les formes d’aprofitament i en general qualsevol altre aspecte relatiu a l’energia generada.
    </p>
    <p>
...
<h3>3. ENTRADA EN VIGOR I VIGÈNCIA</h3>
    ...
    <p>
        3.1. Aquestes Condicions Específiques estaran en vigor des de la data d’aquestes, si bé la seva vigència queda condicionada a la del Contracte de Subministrament.
    </p>
    <p>
...
<h3>4. CONDICIONS DEL PRODUCTE GURB</h3>
    ...
    <p>
        4.8. En tot cas, SOM ENERGIA, SCCL, serà responsable davant de la Contractant que la Instal·lació compleixi amb la normativa aplicable, així com de disposar de les llicències, autoritzacions, drets, contractes i assegurances pròpies del sector. En aquest sentit, es compromet a vetllar perquè el manteniment i l’operació de la Instal·lació es dugui a terme amb l’objectiu de maximitzar les hores de funcionament. En tot cas, la producció de la Instal·lació dependrà de la seva disponibilitat i de les hores de radiació solar, per la qual cosa variarà en el temps. En cas que la indisponibilitat de la Instal·lació superi els 15 dies naturals consecutius, SOM ENERGIA, SCCL, no facturarà a la Contractant la Quota GURB del mes següent.
    </p>
    <p>
        4.9. SOM ENERGIA, SCCL, no serà responsable davant la Contractant de l’incompliment de les seves obligacions si és per una causa de força major, entenent per “força major” aquells fenòmens (incloent-hi els casos fortuïts) naturals, artificials, accidents inevitables, incendis, revolta o motí popular, actes de guerra, per imposició, norma, ordre o acte de qualsevol govern o agència governamental (estatal, autonòmica o local), així com de qualsevol altra autoritat competent, o qualsevol altra causa similar imprevisible, o si és previsible, que fos inevitable, irresistible i que escapés del control de SOM ENERGIA, SCCL.
    </p>
...
<h3>7. INCORPORACIÓ D'UNA NOVA CLÀUSULA 7.1 (BIS) "FACTURACIÓ I PAGAMENT"</h3>
    ...
    <p>
        Aquests imports es repercutiran en la factura a la Contractant segons les lectures informades per l’encarregat de la lectura.
    </p>
...
<h3>8. PREVALENÇA DE LES PRESENTS CONDICIONS ESPECÍFIQUES SOBRE LA CLÀUSULA 8 "AUTOCONSUM"</h3>
    ...
    <p>
        En tot cas, quan en les Condicions Particulars consti que la Instal·lació d’autoconsum col·lectiu sigui amb compensació simplificada d’excedents, s’aplicaran a la Contractant les clàusules (i) 8.5, que regula l’aplicació de la compensació simplificada, i que donem per reproduïda, i (ii) 8.6 en relació amb el descompte Flux Solar.
    </p>
...
<h3>9. ADAPTACIÓ DE LA CLÀUSULA 15 "INFORMACIÓ BÀSICA SOBRE PROTECCIÓ DE DADES"</h3>
    ...
    <p>
        “15.2.(bis) A fi de poder fer efectiva la contractació del producte GURB sol·licitat per la Contractant, la normativa aplicable exigeix lliurar a la distribuïdora un Acord de Repartiment d’excedents on constin el nom complet, DNI, CUPS i signatura de tots els participants. La Contractant accepta expressament la cessió d’aquestes dades personals a la resta de participants i a la distribuïdora, i s’obliga igualment a mantenir absoluta confidencialitat sobre les dades personals a les quals tindrà accés amb motiu de la signatura d’aquest Acord de Repartiment.
    </p>
    <p>
        Així mateix, s’informa la Contractant que el responsable del tractament de les seves dades és SOM ENERGIA, SCCL, i que la finalitat del seu tractament és gestionar i tramitar l’autoconsum contractat sobre la base de l’acord contractual signat entre totes dues parts. Excepte l’obligada cessió indicada, les seves dades no se cediran, excepte en els supòsits legalment exigits i només es conservaran mentre la relació contractual estigui vigent i, una vegada finalitzada aquesta, dins dels terminis legals previstos. Pot retirar el seu consentiment en qualsevol moment i exercir el seu dret d’accés, rectificació, supressió, portabilitat, limitació i oposició adreçant-se a somenergia@delegado-datos.com (delegat de protecció de dades). En cas de divergències, pot presentar una reclamació davant l’Agència de Protecció de Dades (www.aepd.es).”
    </p>
    <p>
        SOM ENERGIA, SCCL, ha posat a la disposició de la Contractant aquestes Condicions Específiques abans de la seva contractació a través de la seva pàgina web www.somenergia.coop. Aquestes han estat subscrites mitjançant sistemes de contractació electrònica, i s’ha emès un exemplar en suport durador a la Contractant una vegada acabada la contractació.
    </p>
</div>
</%def>
...
<h3>7. INCORPORACIÓN DE UNA NUEVA CLÁUSULA 7.1 (BIS) "FACTURACIÓN Y PAGO"</h3>
    <p>
    ...
    <p>
        Estos importes se repercutirán en la factura a la Contratante según las lecturas informadas por el encargado de la lectura.
    </p>
