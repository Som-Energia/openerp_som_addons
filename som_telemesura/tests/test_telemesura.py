...
class BaseTests(testing.OOTestCase):
    ...
    def test_parse_to_utc_october(self):
        result = []
        expected_october = ['2017-10-28 22:00:00', '2017-10-28 23:00:00',
    ...
    def test_parse_to_utc_march(self):
        result = []
        expected_march = ['2018-03-24 23:00:00', '2018-03-25 00:00:00',
                          '2018-03-25 01:00:00', '2018-03-25 02:00:00',
                          '2018-03-25 03:00:00']
    ...
    def test_create_new_tm_profile(self):
        ...
        with Transaction().start(self.database) as txn:
            ...
            created = profile_obj.read(cursor, uid, new_id, ['timestamp',
                                                             'utc_timestamp',
                                                             'utc_gkwh_timestamp'])
