...
class TestWizardGestioTextToPolissa(testing.OOTestCaseWithCursor):
    ...
    def test_get_polissa_ids_from_f1_pol_activa(self):
        ...
        other_pols_id = pol_o.search(
            self.cursor, self.uid, [("cups", "=", pol.cups.id), ("state", "!=", "activa")]
        )
        ...
        fecha_factura_hasta = datetime.strptime(fecha_factura_desde, "%Y-%m-%d") + timedelta(
            days=15
        )
        ...
        f1_o.write(
            ...
            {
                "cups_id": pol.cups.id,
                "fecha_factura_desde": fecha_factura_desde,
                "fecha_factura_hasta": fecha_factura_hasta,
    ...
    def test_get_polissa_ids_from_f1__many(self):
        ...
        vals1 = {
            "cups_id": cups1_data.id,
            "cups_text": cups1_data.name,
            "fecha_factura_desde": "2021-06-01",
            "fecha_factura_hasta": "2021-07-01",
        }
        vals2 = {
            "cups_id": cups2_data.id,
    ...
    def test_get_polissa_ids_from_f1__out_of_f1_date_range(self):
        ...
        pol_vals = {"lot_facturacio": False, "data_baixa": "2021-05-30", "data_alta": "2021-01-01"}
        pol_obj.write(self.cursor, self.uid, pol_id, pol_vals)
