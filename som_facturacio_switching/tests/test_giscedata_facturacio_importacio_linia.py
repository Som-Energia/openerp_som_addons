...
class TestGiscedataFacturacioImportacioLinia(testing.OOTestCaseWithCursor):
    ...
    def test_do_reimport_f1_select_one_f1(self, mock_function):
        ...
        data = {
            "error_codes": [{"code": "2999", "text": "no file in gridfs"}],
            "days_to_check": 30,
        }
    ...
    def test_do_reimport_f1_two_f1_same_cups(self, mock_function):
        ...
        self.f1_obj.write(
            self.cursor, self.uid, f1_id, {"fecha_factura_desde": "2022-02-02"}
        )
        self.f1_obj.write(
            self.cursor, self.uid, f2_id, {"fecha_factura_desde": "2022-01-02"}
        )
        data = {
            "error_codes": [{"code": "2999", "text": "no file in gridfs"}],
            "days_to_check": 30,
