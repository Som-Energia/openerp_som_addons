    ...
    def test_validation_3035S_ok(self):
        ...
        with Transaction().start(self.database) as txn:
            ...
            err_template_id = imd_obj.get_object_reference(
                cursor, uid, 'som_facturacio_switching', 'error_phase_3_code_S35')[1]
            ...
            self.canvi_potencies(txn, "polissa_tarifa_018",
                                 5.75, {'P1': 4.75, "P2": 5.75})
            ...
            import_id = imd_obj.get_object_reference(
                cursor, uid, 'giscedata_facturacio_switching', 'f1_import_01')[1]
