  ...
  <div class="fila">
    <div class="LogoPpal">
      <a href="https://www.somenergia.coop" target="_blank">
        <img src="${addons_path}/som_assets/img/logo.svg" width="150" height="150"/ alt="Logo Som Energia">
      </a><br>
...
<div>
  <div class="footer">
    <p class="TextPeu">${_(u"Som Energia, SCCL, CIF F55091367 | Domicili Riu Güell, 68 - 17005 - Girona | generationkwh@somenergia.coop | www.somenergia.coop")}</p>
  </div>
</div>
