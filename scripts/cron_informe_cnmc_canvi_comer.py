...
def generate_report(year, month, agent, sequence):
    ...
    print {'file_type': 'SI', 'start_date': date_time_start.strftime(
        '%Y-%m-%d'), 'end_date': date_time_end.strftime('%Y-%m-%d')}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--agent', metavar='AGENT', nargs='?',
                        default='R2-415', help='Agent code ')
