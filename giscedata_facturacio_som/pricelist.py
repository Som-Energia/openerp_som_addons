...
class ProductPricelist(osv.osv):
    ...
    def get_atr_price_from_pricelist(self, cursor, uid, ids, tipus, product_id,
                                     fiscal_position_id, with_taxes=False, direccio_pagament=None,
                                     titular=None, context=None):
    ...
    def get_atr_price_from_report(self, cursor, uid, polissa, period_name, tipus, context, with_taxes=False):
