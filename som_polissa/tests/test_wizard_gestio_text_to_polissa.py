...
class TestWizardGestioTextToPolissa(testing.OOTestCaseWithCursor):
    ...
    def test_wizard_gestio_text_to_polissa__from_polissa(self):
        ...
        new_comment = pol_o.read(
            self.cursor, self.uid, pol_id, ["info_gestions_massives"]
    ...
    def test_wizard_gestio_text_to_polissa__from_polissa__manyPolisses(self):
        ...
        new_comments = pol_o.read(
            self.cursor, self.uid, pol_ids, ["info_gestions_massives"]
        )
        self.assertEqual(
    ...
    def test_wizard_gestio_text_to_polissa__from_polissa_gest_endarrerida(self):
        ...
        pol_o.write(
            self.cursor, self.uid, pol_id, {"info_gestio_endarrerida": "previous text"}
        )
        ...
        self.assertEqual(
            new_comment["info_gestio_endarrerida"], "comentari test 1\nprevious text"
        )
